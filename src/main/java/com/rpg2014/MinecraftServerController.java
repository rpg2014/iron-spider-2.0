...
import com.rpg2014.wrappers.EC2.SpidermanEC2Wrapper;
...
@Path("/server")
@Slf4j
public class MinecraftServerController implements ServerControllerInterface {
    TaskRunner taskRunner = new TaskRunner(SpidermanEC2Wrapper.getInstance());
    UpdateDNSTask updateDNSTask = UpdateDNSTask.builder()
            .url(System.getenv("minecraftURL"))
